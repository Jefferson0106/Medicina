<template>
  ...
  <main>
    <nav class="main-menu">
      <h1>Fitness App</h1>
      <img class="logo" src="@/assets/mujerpng.png" alt="" />
      <ul>
    ...
    <section class="content">
      <div class="left-content">
        <div class="activities">
          <h1>Los Mejores Especialista</h1>
          <div class="activity-container">
            <div class="image-container img-one">
              <img src="@/assets/mujerpng.png" alt="Laura" />
              <div class="overlay">
                <h3>Pediatra</h3>
              </div>
            </div>
            ...
            <div class="image-container img-two">
              <img src="@/assets/jefferson.png" alt="Jefferson" />
              <div class="overlay">
                <h3>psicologo</h3>
              </div>
            </div>
            ...
            <div class="image-container img-three">
              <img src="@/assets/grupalpng.png" alt="running" />
              <div class="overlay">
                <h3>Siruganos Pediatrico</h3>
              </div>
            </div>

            <div class="image-container img-four">
              <img src="@/assets/grupal.jpg" alt="cycling" />
              <div class="overlay">
                <h3>ciruganos generales</h3>
              </div>
            </div>

            <div class="image-container img-five">
              <img src="@/assets/nutricionistra.jpg" alt="yoga" />
              <div class="overlay">
                <h3>Nutricionista</h3>
              </div>
            </div>
            ...
            <div class="image-container img-six">
              <img src="@/assets/portada.jpg" alt="swimming" />
              <div class="overlay">
                <h3>los mejores Especialista</h3>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="calendar">
              <div class="day-and-activity activity-one">
                ...
                <div class="activity">
                  ...
                  <div class="participants">
                    <img src="@/assets/jefferson.png"   style="--i: 1" alt="" />
                    <img src="@/assets/manzana.jpg"   style="--i: 2" alt="" />
                    <img src="@/assets/blanco.jpg"    style="--i: 2" alt="" />
                    <img src="@/assets/desayunando.jpg"   style="--i: 2" alt="" />
                  </div>
                </div>
                <button class="btn" v-on:click="reguistro()">reguistro</button>
              </div>
              ...
              <div class="day-and-activity activity-two">
                ...
                <div class="activity">
                  <h2>Pediatra</h2>
                  <div class="participants">
                    <img src="@/assets/mujerpng.png" style="--i: 1" alt="" />
                    <img src="@/assets/nutricionistra.jpg" style="--i: 2" alt="" />
                  </div>
                </div>
                <button class="btn" v-on:click="reguistro()">reguistro</button>
              </div>
              ...
              <div class="day-and-activity activity-three">
                ...
                <div class="activity">
                  ...
                  <div class="participants">
                    <img src="@/assets/jefferson.png" style="--i: 1" alt="" />
                    <img src="@/assets/nutricionistra.jpg" style="--i: 2" alt="" />
                    <img src="@/assets/manzana.jpg" style="--i: 3" alt="" />
                  </div>
                </div>
                <button class="btn" v-on:click="reguistro()">reguistro</button>
              </div>
              ...
              <div class="day-and-activity activity-four">
                ...
                <div class="activity">
                  <h2>Hiking</h2>
                  <div class="participants">
                    <img src="@/assets/manzana.jpg" style="--i: 1" alt="" />
                    <img src="@/assets/manzana.jpg" style="--i: 2" alt="" />
                    <img src="@/assets/nutricionistra.jpg" alt="" />
                    <img src="@/assets/nutricionistra.jpg" style="--i: 4" alt="" />
                    <img src="@/assets/nutricionistra.jpg" style="--i: 5" alt="" />
                  </div>
                </div>
                <button class="btn" v-on:click="reguistro()">reguistro</button>
              </div>
      ...
      <div class="right-content">
        <div class="user-info">
          ...
          <h4>Kelsey Miller</h4>
          <img src="@/assets/jefferson.png" alt="user" />
        </div>
        ...
        <div class="friends-activity">
          ...
          <div class="card-container">
            <div class="card">
              ...
              <img class="card-img" src="@/assets/manzana.jpg" alt="" />
        ...
        <img src="@/assets/face.svg" alt="icono"  style="width: 20px  !important;">
      </a>
      <a href="https://www.instagram.com/" target="_blank">
          <img src="@/assets/intagram.svg" alt="icono" style="width: 20px !important;">
        </a>
              </div>
          </div>
          <div class="form-group">
          <button type="button" class="btn btn-dark margen " v-on:click="publicidad()">publicidad</button>
        </div>
        </div>
        <div class="form-group">
          <button type="button" class="btn btn-dark margen " v-on:click="Informacion()">Informacion de Paciente</button>
        </div>
      </div>
    </section>
  </main>
...
methods: {
  reguistro(){
    this.$router.push('/ReguistroQdes')
  },
  Informacion(){
    this.$router.push('/TabletaINfom')
  },
  publicidad(){
    this.$router.push('/PublicidaDad')
  }
}
}
</script>
